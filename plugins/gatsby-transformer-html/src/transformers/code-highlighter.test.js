...
describe("extractDirective", function () {
  it("must extract directives correctly", function () {
    const comments = {
      "/* highlight-range{1-2} */": { action: "highlight", start: 1, end: 3 },
      "// highlight-line": { action: "highlight", start: 0, end: 1 },
      "// highlight-next-line": { action: "highlight", start: 1, end: 2 },
      "/* hide-range{23-40} */": { action: "hide", start: 23, end: 41 },
      "// hide-line": { action: "hide", start: 0, end: 1 },
      "// hide-next-line": { action: "hide", start: 1, end: 2 },
      "//hide-line": { action: "hide", start: 0, end: 1 },
      "//    hide-line": { action: "hide", start: 0, end: 1 },
      "/**hide-line*/": { action: "hide", start: 0, end: 1 },
      "/**  hide-line  */": { action: "hide", start: 0, end: 1 },
